...
<form action="" method="POST">
    ...
    <fieldset>
        ...
        <div class="margin-form">
            <input id="adv_link" type="text" name="shop_id" value="<?=$this->escape($this->getConfigValue('SHOP_ID'));?>" style="width:250px" />
        </div>

        <label for="adv_link"><?=$this->l('API key');?></label>
        <div class="margin-form">
            <input id="adv_link" type="text" name="api_key" value="<?=$this->escape($this->getConfigValue('API_KEY'));?>" style="width:250px" />
        ...
        <div class="margin-form">
            ...
            <input type="radio" name="javascript" id="webwinkelkeur-javascript-on" value="1" <?php if ($this->getConfigValue('JAVASCRIPT')) {
    echo 'checked';
} ?> />
            ...
            <input type="radio" name="javascript" id="webwinkelkeur-javascript-off" value="" <?php if (!$this->getConfigValue('JAVASCRIPT')) {
    echo 'checked';
} ?> />
        ...
        <div class="margin-form">
            ...
            <input type="radio" name="invite" id="webwinkelkeur-invite-on" value="1" <?php if ($this->getConfigValue('INVITE') == 1) {
    echo 'checked';
} ?> />
            ...
            <input type="radio" name="invite" id="webwinkelkeur-invite-first" value="2" <?php if ($this->getConfigValue('INVITE') == 2) {
    echo 'checked';
} ?> />
            ...
            <input type="radio" name="invite" id="webwinkelkeur-invite-off" value="" <?php if (!$this->getConfigValue('INVITE')) {
    echo 'checked';
} ?> />
        ...
        <div class="margin-form">
            <input id="adv_link" type="number" required min="0" name="invite_delay" value="<?=$this->escape($this->getConfigValue('INVITE_DELAY', null, null, null, 3));?>" style="width:50px" />
            <p class="preference_description">
        ...
        <div class="margin-form">
            <input id="adv_link" type="number" required min="1" name="invite_first_order_id" value="<?=$this->escape($this->getConfigValue('INVITE_FIRST_ORDER_ID', null, null, null, $this->getLastOrderId() + 1));?>" style="width:50px" />
            <p class="preference_description">
        ...
        <div class="margin-form">
            ...
            <input type="radio" name="rich_snippet" id="webwinkelkeur-rich-snippet-on" value="1" <?php if ($this->getConfigValue('RICH_SNIPPET')) {
    echo 'checked';
} ?> />
            ...
            <input type="radio" name="rich_snippet" id="webwinkelkeur-rich-snippet-off" value="" <?php if (!$this->getConfigValue('RICH_SNIPPET')) {
    echo 'checked';
} ?> />
        ...
        <div class="margin-form">
            <label class="t">
                <input type="checkbox" name="limit_order_data" value="1" <?php if ($this->getConfigValue('LIMIT_ORDER_DATA')) {
    echo 'checked ';
} ?>/>
